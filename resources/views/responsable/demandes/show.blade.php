...
<a href="{{ route('responsable.demandes.index') }}" class="btn-back"><i class="bi bi-arrow-left"></i> Retour</a>
...
<div class="detail-card">
    ...
    <form method="POST" action="{{ route('responsable.demandes.valider', $demande->id_demande) }}">
        @csrf
    ...
    <form method="POST" action="{{ route('responsable.demandes.rejeter', $demande->id_demande) }}" class="mt-2">
        @csrf
